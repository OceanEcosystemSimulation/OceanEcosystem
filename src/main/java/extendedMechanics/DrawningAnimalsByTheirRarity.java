...
public class DrawningAnimalsByTheirRarity implements IAnimalDrawer {
    ...
    static {
        ...
        rarityDrawning.put(Rarity.MYTHIC, List.of("Whale","Turtle", "Crab", "Shrimp", "Octopus")); //dla testu usuwam Orca i Whale z MYTHIC i daje do SUPER_RARE
        rarityDrawning.put(Rarity.SUPER_RARE, List.of("Shark", "OceanicPuffer","Orca", "Seal"));
        rarityDrawning.put(Rarity.RARE, List.of("Nemo", "Dolphin",  "Star"));
    }
