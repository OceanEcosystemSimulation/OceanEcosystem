...
public class DrawningAnimalsByTheirRarity implements IAnimalDrawer {
    ...
    static {
        ...
        rarityDrawning.put(Rarity.MYTHIC, List.of("Starfish", "Seal", "Crab", "Octopus")); //dla testu usuwam Orca i Whale z MYTHIC i daje do SUPER_RARE
        rarityDrawning.put(Rarity.SUPER_RARE, List.of("Shark", "Dolphin", "Orca"));
        rarityDrawning.put(Rarity.RARE, List.of("Nemo","OceanicPuffer", "Whale"));
    }
